...
function ProductEdit() {
        ...
        function handleSubmit(event) {
            ...
            if (!oid || !customer || !label || !bid || !gid || !bcolor || !team || !bdesc || !xs || !s || !m || !l || !xl || !xxl || !xxxl || !ttl || !start || !end) {
            ...
            event.preventDefault();
            axios.put(`http://localhost:3030/update/${oid}/`, { oid, customer, label, bid, gid, bcolor, team, bdesc, xs, s, m, l, xl, xxl, xxxl, ttl, start, end })
                .then(res => {
                    console.log(res);
