...
function ProductEdit() {
        ...
        const { oid } = useParams(); // Get oid from URL
        ...
        //Submit user input to the backend server
    ...
    useEffect(() => {
        axios.get(`http://localhost:3030/oneOrder/${oid}`)
            .then(response => {
    ...
    }, [oid]); // Dependency array with oid to re-fetch data when oid changes
